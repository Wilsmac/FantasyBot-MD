...
if (!text) throw `${lenguajeGB['smsAvisoMG']()}*𝙴𝚂𝙲𝚁𝙸𝙱𝙰 𝙴𝙻 𝙽𝙾𝙼𝙱𝚁𝙴 𝙳𝙴 𝙻𝙰 𝙲𝙰𝙽𝙲𝙸́𝙾𝙽 𝙾 𝚃𝙸𝚃𝚄𝙻𝙾, 𝙴𝙹𝙴𝙼𝙿𝙻𝙾:*\n*${usedPrefix + command} Ari Abdul - taste*`
try {
...
contextInfo: {
externalAdReply: {
title: 'descargando su música, aguarde un momento',
body: packname,
