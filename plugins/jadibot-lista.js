...
const responseMessage = `🌺 𝙻𝙸𝚂𝚃𝙰 𝙳𝙴 𝚂𝚄𝙱 𝙱𝙾𝚈𝚂 𝙰𝙲𝚃𝙸𝚅𝙾𝚂\n\n𝙿𝚄𝙴𝙳𝙴𝚂 𝙿𝙴𝚁𝙳𝙸𝙻𝙴 𝙰 𝚄𝙱𝙻 𝚀𝚄𝙴 𝚂𝙴 𝚄𝙽𝙰 𝙰 𝚃𝚄 𝙶𝚁𝚄𝙿𝙾, 𝚂𝙴 𝚁𝙴𝚂𝙿𝙴𝚃𝚄𝙾𝚂𝙾\n\n 𝚂𝙸 𝙴𝙻.𝚃𝙴𝚇𝚃𝙾 𝙴𝚂𝚃𝙰 𝙴𝙽 𝙱𝙻𝙰𝙽𝙲𝙾 𝙴𝚂 𝙿𝙾𝚁𝚀𝚄𝙴 𝙽𝙾 𝙷𝙰𝚈 𝚂𝚄𝙱 𝙱𝙾𝚈𝚂𝙰𝙲𝚃𝙸𝚅𝙾𝚂\n\n𝙲𝙰𝙳𝙰 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝚂𝚄𝙱 𝙱𝙾𝚃 𝙼𝙰𝙽𝙴𝙹𝙰 𝙻𝙰 𝙵𝚄𝙽𝙲𝙸𝙾𝙽 𝙲𝙾𝙼𝙾 𝚀𝚄𝙸𝙴𝚁𝙰, 𝙴𝙻 𝙽𝚄́𝙼𝙴𝚁𝙾 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻 𝙽𝙾 𝚂𝙴 𝙷𝙰𝙲𝙴 𝚁𝙴𝚂𝙿𝙾𝙽𝚂𝙰𝙱𝙻𝙴\n\n𝚂𝚄𝙱 𝙱𝙾𝚃𝚂 𝙰𝙲𝙶𝙸𝚅𝙾𝚂 : ${totalUsers || '0'}\n\n${replyMessage.trim()}`.trim();
