...
user.name = user.name === 0 ? sinDefinir : user.name + 'ͧͧͧͦꙶͣͤ✓ᚲᴄᴅ'
...
❱❱ ${sn}\n
✅ *INSIGNIA DE VERIFICACIÓN*
❱❱   *${user.registered === true ? 'ͧͧͧͦꙶͣͤ✓ᚲᴄᴅ' : ''}*\n
✨ *NOMBRE* 
❱❱ ${user.name}\n
👀 *DESCRIPCIÓN*
❱❱ ${user.descripcion}\n
