...
correo = official[0][0] == String(contact[0]) ? 'socialplus.gata@gamil.com' : official[1][0] == String(contact[0]) ? 'indefinido202@gmail.com' : official[2][0] == String(contact[0]) ? 'alexismaldonado90700@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'Estados Unidos🇺🇲' : official[1][0] == String(contact[0]) ? 'Estados Unidos🇺🇲 : official[2][0] == String(contact[0]) ? 'Estados Unidos'🇺🇲' : official[3][0] == String(contact[0]) ? 'Eatados unidos 🇺🇲' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/Wilsmac' : official[1][0] == String(contact[0]) ? 'https://github.com/Wilsmac' : official[2][0] == String(contact[0]) ? 'https://github.com/Wilsmac' : official[3][0] == String(contact[0]) ? 'Wilsmac' : md 
