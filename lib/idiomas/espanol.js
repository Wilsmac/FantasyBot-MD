...
const smsCodigoQR = () => { return `\n♻️ ESCANEA EL CÓDIGO QR EXPIRA EN 45 SEGUNDOS ☑️`}
...
const eGataCoins = () => { return '𝑇𝑂𝐾𝐼𝑇𝑂𝐶𝑜𝑖𝑛𝑠' }
...
const smsMens1 = () => { return `𝑪𝑶𝑴𝑨𝑵𝑫𝑶`} 
const smsMens2 = () => { return `𝑨𝑪𝑻𝑼𝑨𝑳𝑴𝑬𝑵𝑻𝑬`} 
const smsMens3 = () => { return `𝑬𝑵 𝑬𝑺𝑻𝑬`} 
const smsMens4 = () => { return `𝑩𝑶𝑻`} 
const smsMens5 = () => { return `𝑪𝑯𝑨𝑻`} 
