...
const smsRowner = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾́𝙻𝙾 𝚈𝙾 𝙲𝙾𝙼𝙾 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙳𝙴𝙻 𝙱𝙾𝚃 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁!\`\`\`` }//NUMERO DE BOT
...
const smsAdmin = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾́𝙻𝙾 𝙴𝚂 𝙿𝙰𝚁𝙰 𝙰𝙳𝙼𝙸𝙽𝚂 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!\`\`\`` }//ADMINS
